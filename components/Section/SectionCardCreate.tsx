...
const SectionCardCreate: React.FC<SectionCardCreateProps> = ({
  notebook_id,
}) => {
  ...
  const { register, handleSubmit } = useForm<CreateSectionInputs>({
    defaultValues: {
      title: "",
    },
  });
    ...
    <>
      ...
      >
        <form onSubmit={handleSubmit(onCreateSection)}>
          ...
          <Input type="submit" disabled={createLoading} />
        </form>
      </CustomDialog>
